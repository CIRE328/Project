...
public class NurseContent {
    ...
    public NurseContent(Integer id, String serialNumber, String nursingName, String servicePrice,
                        String message, Integer status, String executionCycle, String executionTimes, Boolean isDeleted) {
        this.id = id;
    ...
    public String getExecutionTimes() { return executionTimes; }
    public void setExecutionTimes(String executionTimes) { this.executionTimes = executionTimes; }
